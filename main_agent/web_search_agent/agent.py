...
web_research_agent = LlmAgent(
    ...
    # Switching to 2.0-flash for better tool-calling stability with google_search
    model="gemini-2.5-flash", 
    description="A generalized research assistant capable of fetching real-time information from the web.",
    instruction="""
    ...
    """,
    tools=[google_search]  # ✅ Tool is isolated here
)